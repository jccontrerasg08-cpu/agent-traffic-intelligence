...
| Anthropic | Shared crawler publication | Not configured | Not assumed | Shared ranges establish provider-level crawler infrastructure only; they do not distinguish ClaudeBot, Claude-SearchBot and Claude-User. |
